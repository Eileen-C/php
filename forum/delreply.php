...
mysql_select_db($database_forum, $forum);
$query_Recordset1 = sprintf("SELECT * FROM reply WHERE ID = %s", $colname_Recordset1);
...
mysql_select_db($database_forum, $forum);
$query_Recordset2 = sprintf("SELECT * FROM topic WHERE TopicID = %s", $colname_Recordset2);
